...
class TestAgentService(unittest.TestCase):
    ...
    def test_exec_on_queue_deleted_cmd(self):
        ...
        response = CommandResponse()
        on_queue_deleted_manager = Mock()
        self.agent_service._on_queue_deleted_manager = on_queue_deleted_manager

        self.agent_service._exec_on_queue_deleted_cmd(command, response)

        on_queue_deleted_manager.on_queue_deleted.assert_called_once_with(queue_id)
