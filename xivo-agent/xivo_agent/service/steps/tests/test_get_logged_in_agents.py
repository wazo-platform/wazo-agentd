...
class TestGetLoggedInAgentsStep(unittest.TestCase):
    ...
    def test_logged_in_agent_ids(self):
        ...
        agent_login_dao.get_statuses.return_value = [status1, status2, status3]
    ...
    def test_get_agent_and_status(self):
        ...
        agent_login_dao.get_status.return_value = status
        ...
        agent_login_dao.get_status.assert_called_once_with(agent_id)
